...
```
The script shows a R example of geospatial masking, plotting precipitation of a gridded Lambert netCDF file with a watershed in polygon shapefile on Google Map.
...
```
### read in gridded NetCDF file for the Maumee River basin
```{r}
